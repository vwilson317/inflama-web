...
export const MOCK_MEN: Profile[] = [
  ...
  },
  {
    ...
    name: 'Bruno',
    age: 32,
    imageUri: getCloudflareImageUrl('profiles/m2.jpg'),
    countryCode: 'PT',
  ...
  },
  {
    ...
    name: 'Lucas',
    age: 25,
    imageUri: getCloudflareImageUrl('profiles/m3.jpg'),
    countryCode: 'AR',
  ...
  },
  {
    ...
    name: 'Diego',
    age: 30,
    imageUri: getCloudflareImageUrl('profiles/m4.jpg'),
    countryCode: 'CO',
    currentLocation: 'Rio de Janeiro',
    leavingAt: addDays(now, 1),
    gender: 'male',
  ...
  },
  {
    ...
    name: 'Thiago',
    age: 27,
    imageUri: getCloudflareImageUrl('profiles/m5.jpg'),
    countryCode: 'BR',
...
export const MOCK_WOMEN: Profile[] = [
  {
    ...
    name: 'Beatriz',
    age: 26,
    imageUri: getCloudflareImageUrl('profiles/w1.jpg'),
    countryCode: 'BR',
    currentLocation: 'Rio de Janeiro',
  ...
  },
  {
    ...
    name: 'Marina',
    age: 29,
    imageUri: getCloudflareImageUrl('profiles/w2.jpg'),
    countryCode: 'ES',
    currentLocation: 'Salvador',
  ...
  },
  {
    ...
    name: 'Camila',
    age: 24,
    imageUri: getCloudflareImageUrl('profiles/w3.jpg'),
    countryCode: 'BR',
    currentLocation: 'São Paulo',
  ...
  },
  {
    ...
    name: 'Larissa',
    age: 31,
    imageUri: getCloudflareImageUrl('profiles/w4.jpg'),
    countryCode: 'UY',
    currentLocation: 'Rio de Janeiro',
  ...
  },
  {
    ...
    name: 'Fernanda',
    age: 27,
    imageUri: getCloudflareImageUrl('profiles/w5.jpg'),
    countryCode: 'BR',
    currentLocation: 'Florianópolis',
